...
class Qwen3DLLMRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        Qwen3DLLMRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Qwen3DLLMDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3DLLMConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class Qwen3DLLMPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["Qwen3DLLMDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": Qwen3DLLMDecoderLayer,
        "attentions": Qwen3DLLMAttention,
    }


class Qwen3DLLMRotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen3DLLMConfig, device=None):
        super().__init__()
...
class Qwen3DLLMForMaskedLM(Qwen3DLLMPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = Qwen3DLLMModel(config)
        self.vocab_size = config.vocab_size
