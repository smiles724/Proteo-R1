...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(self, model_path,
        fsdp_config,
        optim_config,
        ...
        with init_context(), warnings.catch_warnings():
            ...
            # actor_module = actor_module_class.from_pretrained(pretrained_model_name_or_path=local_path,   # todo: change the model here!!!
