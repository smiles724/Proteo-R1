from proteor1.generate.data_load.types import Record, StructureInfo, AntibodyInfo
from proteor1.generate.data_load.filter.dynamic.filter import DynamicFilter
