...
class ProteinAgent(BaseAgent):
    """
    A protein agent that solves mathematical problems step by step, following the BaseAgent interface.
    """
    ...
    def __init__(self, accumulate_thinking=True):
        ...
        """
        self.instruction = "Let's think step by step, and put your final answer within \\boxed{}."   # todo: change to bio-specific?
