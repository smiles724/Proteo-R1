...
def get_struc_seq(foldseek, path, chains: list = None, process_id: int = 0, plddt_mask: bool = False, plddt_threshold: float = 70.0, foldseek_verbose: bool = False) -> dict:
    """
        ...
        for i, line in enumerate(r):
            ...
            if chains is None or chain in chains:
                if chain not in seq_dict:
                    combined_seq = "".join([a + b.lower() for a, b in zip(seq, struc_seq, strict=False)])
...
if __name__ == "__main__":
    ...
    res = get_struc_seq(foldseek, test_path, plddt_path=plddt_path, plddt_threshold=70.0)
    print(res["A"][1].lower())
