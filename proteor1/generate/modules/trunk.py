...
from proteor1.generate.layers.attention import AttentionPairBias
from proteor1.generate.layers.dropout import get_dropout_mask
from proteor1.generate.layers.outer_product_mean import OuterProductMean
from proteor1.generate.layers.pair_averaging import PairWeightedAveraging
from proteor1.generate.layers.transition import Transition
from proteor1.generate.layers.triangular_attention.attention import (
    TriangleAttentionEndingNode,
    TriangleAttentionStartingNode,
)
from proteor1.generate.layers.triangular_mult import (
    TriangleMultiplicationIncoming,
    TriangleMultiplicationOutgoing,
)
from proteor1.generate.modules.encoders import AtomAttentionEncoder
...
class MSAModule(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if offload_to_cpu:
            warnings.warn(
                "offload_to_cpu=True is not supported with PyTorch native checkpoint. "
                "Setting offload_to_cpu=False. Consider using fairscale if CPU offloading is required.",
                UserWarning,
                stacklevel=2,
            )
