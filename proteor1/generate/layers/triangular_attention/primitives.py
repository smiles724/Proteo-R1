...
from proteor1.generate.layers import initialize
...
if fa_is_installed:
    ...
    # In flash_attn >= 2.6, the function was renamed from flash_attn_unpadded_kvpacked_func
    # to flash_attn_varlen_kvpacked_func
    try:
